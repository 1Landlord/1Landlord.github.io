...
$(function(){$(".owl-carousel").owlCarousel({margin:20,nav:!1,responsiveClass:!0,responsive:{0:{items:1},480:{items:2},730:{items:3},1050:{items:4},1230:{items:5}}}),$(function(){$(".cardWrap .card").equalHeights()}),$("a[rel='m_PageScroll2id']").mPageScroll2id({}),$(".popup-zoom").magnificPopup({type:"inline",overflowY:"scroll",closeBtnInside:!0,midClick:!0,removalDelay:300,mainClass:"my-mfp-zoom-in"})}),$(window).on("load",function(){$(".preloader").delay(1e3).fadeOut("slow")});